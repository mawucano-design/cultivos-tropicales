...
def inicializar_gee():
    ...
    try:
        ...
        # Fallback: autenticación local (desarrollo en tu máquina Linux)
        try:
...
def descargar_datos_sentinel2_simulado(gdf, fecha_inicio, fecha_fin, indice='NDVI'):
    ...
    try:
        ...
        datos_simulados = {
            ...
            'resolucion': '10m',
            'estado': 'simulado',
            'nota': 'Datos simulados para demostración. Para datos reales, autentícate con Google Earth Engine.'
        }
...
nutriente = None
satelite_seleccionado = "SENTINEL-2_GEE" if GEE_AVAILABLE and st.session_state.gee_authenticated else "SENTINEL-2"
...
with st.sidebar:
    ...
    # Agregar opciones de GEE si está disponible y autenticado
    ...
    # Siempre agregar opciones simuladas
    ...
    satelite_seleccionado = st.selectbox(
        ...
        index=0 if (GEE_AVAILABLE and st.session_state.gee_authenticated) else len(opciones_satelites)-1
    )
...
# [Funciones cargar_shapefile_desde_zip, parsear_kml_manual, cargar_kml, cargar_archivo_parcela - mantén las existentes]
...
# [Funciones generar_dem_sintetico, calcular_pendiente, generar_curvas_nivel - mantén las existentes]
...
# [Funciones analizar_fertilidad_actual, analizar_recomendaciones_npk, analizar_costos, analizar_proyecciones_cosecha, clasificar_textura_suelo, analizar_textura_suelo - mantén las existentes]
...
# [Funciones crear_mapa_fertilidad, crear_mapa_npk, crear_mapa_texturas, crear_grafico_distribucion_costos, crear_grafico_composicion_textura, crear_grafico_proyecciones_rendimiento - mantén las existentes]
...
# [Funciones crear_mapa_pendientes, crear_mapa_curvas_nivel, crear_visualizacion_3d - mantén las existentes]
